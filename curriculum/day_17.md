...
| 한국 | **100만원 이상** — 의무 발동 | 특금법 §5의2 (2022-03-25) |
| 미국 | **$3,000 이상** — 의무 발동 | BSA Travel Rule (1996) |
| EU | 금액 무관 전건 | TFR (2024-12-30) |
| 싱가포르 | 금액 무관 전건 (S$1,500은 정보 항목 기준) | MAS PSA |
| 일본 | 금액 무관 전건 (10만엔은 CDD 기준) | 범수법 §10의5 |

> ⚠️ 금액 기준은 **두 종류**다. 한국·미국은 그 금액 미만이면 의무 자체가 없고, 나머지는 의무가 전건에 걸리며 금액은 **넘길 정보 항목만** 늘린다. 상세는 [`../notes/3-crypto-aml/travel-rule.md`](../notes/3-crypto-aml/travel-rule.md) §3.
