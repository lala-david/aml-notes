...
📖 오늘 뭘 배우나 (prose intro, 3~5 문장)
🗺 오늘의 지도 (Mermaid 다이어그램 — 그날의 개념 지도)
🎯 핵심 질문 (3개)
📖 읽기 (~50분, 기존 노트 링크)
🌐 외부 자료 (선택, 링크)
🛠️ 미니 챌린지 (~20분, 구체 과제)
...
60일 전 회차 모두 **고유한 Mermaid 다이어그램** 1개씩을 포함합니다 (D1~D60 = 60개 서로 다른 지도). 토픽의 구조를 먼저 **그림으로 흡수**한 뒤 본문을 읽으면 기억 정착률이 훨씬 높습니다. GitHub은 Mermaid를 네이티브로 렌더링하며, 프린트 HTML은 이미 mmdc로 SVG 임베딩되어 있어 종이에서도 동일하게 보입니다.
...
4. 미니 프로젝트 결과물은 [`../projects/`](../projects/) 에 저장
