...
| 관할 | Travel Rule 의무 발동 | 정보 심화 기준 | 감독 |
|---|---|---|---|
| 🇸🇬 싱가포르 | 금액 무관 전건 | S$1,500 초과 | MAS |
| 🇦🇪 UAE | 금액 무관 전건 | 1 AED | VARA |
| 🇯🇵 일본 | 금액 무관 전건 | 없음 *(10만엔은 CDD 기준)* | FSA + JVCEA |
| 🇭🇰 홍콩 | 금액 무관 전건 | HK$8,000 이상 | SFC |

네 관할 모두 **의무 자체에는 금액 조건이 없습니다.** 한국(100만원)·미국($3,000)처럼 "이 미만은 대상 아님" 구조가 아니라는 점이 비교의 핵심입니다.
