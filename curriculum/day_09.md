...
## 📋 2026-01-29 개정안 적용 로드맵

| 시점 | 사건 |
|---|---|
| 2026-01-29 | 개정 시행 |
| 2026-Q2 | FIU 세부 가이드라인 발표 예상 |
| 2026~ | 신규 M&A·투자 건 전수 재심사 |
| ~2027 | 이행 상황 FIU 점검 시작 |

### 기존 VASP의 대응 3단계

1. **내부 점검 (Q1~Q2 2026)**: 현재 대주주 문서·BO 추적·AML 프로그램 재검토
2. **사전 협의 (Q2~Q3)**: M&A/투자 계획 FIU와 사전 협의 채널 확립
3. **정기 리뷰 (Q4 이후)**: 연 1회 자체 점검 + 변경 시 즉시 신고
