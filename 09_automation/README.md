...
- 60일 커리큘럼: [`../_curriculum/README.md`](../_curriculum/README.md)
- 기술 기반: [`../03_technology/`](../03_technology/)
- 솔루션 시장: [`../05_solutions_market/`](../05_solutions_market/)
