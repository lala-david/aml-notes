...
> AML/가상자산 약어와 한국어/영어 용어. ABC 순. 마지막 업데이트: 2026-04-17.
...
- **APG** (Asia-Pacific Group on Money Laundering) — FATF 지역 기구
- **APT** (Advanced Persistent Threat) — 지속적 표적 공격 (Lazarus 등)
...
- **GENIUS Act** — 미국 stablecoin 입법 (2025-07)
- **GLEIF LEI** (Legal Entity Identifier) — 법인 식별 글로벌 표준
- **Grandfathering** — 기존 사업자 전환기간 (MiCA 등)
...
- **RGB** (Reconnaissance General Bureau) — 북한 정찰총국
...
- **VerifyVASP** — 한국 Travel Rule 솔루션 (Upbit + Chainalysis)

## W

- **Wash Trading** — 가짜 거래 (가격/거래량 부풀리기)
- **Wolfsberg Group** — 글로벌 은행 AML 모범사례 그룹
...
## 더 읽을거리
- [`../notes/1-foundations/key-concepts.md`](../notes/1-foundations/key-concepts.md) — 핵심 개념 정리
