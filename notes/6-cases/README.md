...
> 이론은 배운 뒤, **실제로 무엇이 터졌는지**. 이 폴더는 업계 분기점이 된 사건 계열(글로벌 3개 + 한국 1개)을 서사로 정리합니다. 마지막 업데이트: 2026-04-23.
...
| 5 | [`korea-enforcement.md`](korea-enforcement.md) | Terra-Luna·Wemix·Bithumb·특금법 2021 신고 대란 | 한국형 자율규제·DAXA 공동조치의 실효성·한계 |
