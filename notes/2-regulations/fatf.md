...
### R.16 2025-06 개정의 주요 변화

- **Self-hosted wallet 처리**: VASP가 카운터파티 인지 시 KYC 확장·STR 검토 의무
- **임계값 권고**: €1~$3,000 범위 내 관할 재량
- **Protocol Interop**: 다른 프로토콜도 연결 시도 의무
- **PII 보호**: 암호화 전송 + 보관 기간 명시
- **지속 Supervision**: 분기별 FIU 보고 + ME에서 미흡 VASP 제재

한국 특금법·FIU 고시는 R.16 변화에 대응해 2026년 중 개정 예정.
