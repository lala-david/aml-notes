...
- **Travel Rule**: **금액 무관 전건 적용** + IVMS101 권고. **S$1,500**(≈US$1,100)은 의무 발동선이 아니라 **넘겨야 할 정보 항목이 늘어나는 지점** — 미만 거래에도 성명·계좌번호는 동반해야 한다 *(MAS 사이트 장기 장애로 1차 출처 검증 중)*
- **신용카드 크립토 구매 금지** (2024~)
...
### 의무 핵심
- **Travel Rule**: **금액 무관 전건 적용**. HK$8,000(≈US$1,000)은 의무 발동선이 아니라 **정보 항목이 늘어나는 지점** — 미만 거래에도 송·수신인 성명과 계좌번호는 동반해야 한다 *(SFC 지침이 스캔 이미지라 1차 출처 검증 중)*
