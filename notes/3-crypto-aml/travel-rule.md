...
| 🇭🇰 홍콩 | B | 금액 무관 전건 | HK$8,000 이상 *(검증 중)* | AMLO 부칙2 |
| 🇸🇬 싱가포르 | B | 금액 무관 전건 | S$1,500 초과 *(검증 중)* | MAS PSN02 |
...
*검증 중* 표시는 1차 출처 원문을 아직 확보하지 못했다는 뜻입니다. 싱가포르는 MAS 사이트 장기 장애, 홍콩은 SFC 지침이 스캔 이미지라 본문 추출이 안 됩니다.
