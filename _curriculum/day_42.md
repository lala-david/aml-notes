...
### 구현 가이드
프로젝트: `aml/09_automation/03_mixer_fetcher/`
...
### 산출물
- `09_automation/03_mixer_fetcher/main.py`
- `09_automation/03_mixer_fetcher/README.md`
- `09_automation/03_mixer_fetcher/data/mixer_addresses.json`
- `09_automation/03_mixer_fetcher/data/mixer_addresses.csv`

→ 자세한 가이드: [`../09_automation/03_mixer_fetcher/README.md`](../09_automation/03_mixer_fetcher/README.md)
