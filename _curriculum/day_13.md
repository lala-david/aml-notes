...
## 📖 읽기 (~60분)
- 메인: [`../04_compliance_ops/cdd_edd.md`](../04_compliance_ops/cdd_edd.md) — 3절 (RBA)
- 보조: [`../04_compliance_ops/internal_controls.md`](../04_compliance_ops/internal_controls.md) — 6절 (ERA)
