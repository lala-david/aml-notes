...
## 📖 읽기 (~50분)
- 메인: [`../02_crypto_aml/defi_nft_risks.md`](../02_crypto_aml/defi_nft_risks.md) — 2025-2026 ZKP 트렌드 언급
- 보조: [`../02_crypto_aml/travel_rule.md`](../02_crypto_aml/travel_rule.md) — 7절 B (PII 보호)
- 보조: [`../08_advanced/`](../08_advanced/) — 추가 자료
