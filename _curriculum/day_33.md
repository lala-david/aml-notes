...
## 📖 읽기 (~50분)
- 메인: [`../03_technology/blockchain_analytics.md`](../03_technology/blockchain_analytics.md) — 4절
- 보조: [`../03_technology/kyc_kyt_overview.md`](../03_technology/kyc_kyt_overview.md) — 4절 (Exposure)
