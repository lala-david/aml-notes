...
## 📖 읽기 (~40분)
- 메인: [`../00_overview/key_concepts.md`](../00_overview/key_concepts.md) — 4~10절
- 보조: [`../03_technology/kyc_kyt_overview.md`](../03_technology/kyc_kyt_overview.md) — 5절 (KYC vs KYT 표)
...
## 더 깊이 (선택)
- [`../04_compliance_ops/str_ctr.md`](../04_compliance_ops/str_ctr.md) — STR 운영
