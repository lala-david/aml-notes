...
### 구현 가이드
프로젝트: `aml/09_automation/05_kyt_wrapper/`

- D42 (mixer fetcher) + D49 (OFAC screener) 결과를 통합
- exposure는 D35 (2-hop tracer)와 결합

### 산출물
- `09_automation/05_kyt_wrapper/main.py`
- `09_automation/05_kyt_wrapper/README.md`
- `09_automation/05_kyt_wrapper/sample_results/` (5개 주소 결과)

→ 가이드: [`../09_automation/05_kyt_wrapper/README.md`](../09_automation/05_kyt_wrapper/README.md)
